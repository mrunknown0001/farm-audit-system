...
<div class="content-wrapper">
	<section class="content-header">
		<h1>Auditable Location: <strong>{{ $cat == 'loc' ? $dat->farm->code . ' - ' . $dat->location_name : $dat->location->farm->code . ' - ' . $dat->location->location_name . ' - ' . $dat->sub_location_name }}</strong></h1>
		{{-- <ol class="breadcrumb">
			...
			<div class="col-md-12">
				@foreach($audit_locs as $key => $l)
					@if($auditcontroller->auditCheck($cat, $dat->id, $l->audit_item->id, 1))
						<?php print_r($audititemcontroller->timecheck($l->audit_item->time_range)) ?>
